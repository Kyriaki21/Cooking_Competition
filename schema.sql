...
BEGIN
    ...
    DROP TEMPORARY TABLE TopScorers;
    DROP TEMPORARY TABLE FinalWinners;
END //
...
BEGIN
    ...
    INSERT INTO `Admin` (username, password) VALUES (username, user_password);
END //
...
BEGIN
    ...
    INTO cook_id
    FROM `User` u
    INNER JOIN Cook c ON u.idUser = c.idCook
